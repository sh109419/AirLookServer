...
use Phalcon\Logger\Adapter\Stream as Stream;
...
/**
* 注册邮件发送类 send mail by PHPMailer
*/
...
$di->setShared('logger', function ($logtype) {

        $logfile = BASE_PATH . '/public/logs/'  . date('Ymd_') . $logtype . '.log';
